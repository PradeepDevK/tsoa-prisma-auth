...
export function RegisterRoutes(app: Router) {
    ...
    // ###########################################################################################################
        ...
        app.get('/secure/data',
            ...
            ...(fetchMiddlewares<RequestHandler>(SecureController.prototype.getSecureData)),

            async function SecureController_getSecureData(request: ExRequest, response: ExResponse, next: any) {
